      ...
      <div className="flex justify-center items-center px-6 pt-20">
        ...
        >
          <header className="mb-10 text-center">
            <h2 className="text-4xl font-black uppercase tracking-tighter italic">Welcome <span className="text-primary">Back</span></h2>
            <p className="text-gray-400 font-medium mt-2">Resume your journey to greatness.</p>
          </header>
